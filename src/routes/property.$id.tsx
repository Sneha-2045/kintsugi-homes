...
export const Route = createFileRoute("/property/$id")({
  ...
  head: ({ loaderData }) => {
    if (!loaderData) return { meta: [{ title: "Listing unavailable — Yadori Estate" }] };
    const t = `${loaderData.property.location} — ${formatUsd(loaderData.property.priceUsd)} | Yadori Estate`;
    return {
      meta: [
        { title: t },
  ...
  errorComponent: () => <PageShell title="This listing didn't load" />,
  notFoundComponent: () => (
    <PageShell title="Listing not found" description="This property is no longer in our index.">
      <Button asChild>
...
function PropertyDetails() {
  ...
  const ld = {
    ...
    offers: { "@type": "Offer", price: property.priceUsd, priceCurrency: "USD" },
  };
      ...
      <PageShell title={property.location} description={property.title}>
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[minmax(0,1fr)_340px]">
          <div>
            ...
            <h2 className="mt-8 text-2xl font-bold text-foreground">About this property</h2>
